...
describe('Slack Config Validation', () => {
  beforeEach(() => {
    ...
    vi.stubEnv('ABC_PROVIDER_TOKEN', 'xoxb-1234567890-1234567890-abcdef');
  ...
  it('should successfully load a valid Slack configuration', () => {
    ...
    expect(config.ABC_PROVIDER_TOKEN).toBe('xoxb-1234567890-1234567890-abcdef');
    // @ts-ignore
  ...
  it('should throw an error when ABC_PROVIDER_TOKEN does not start with xoxb-', () => {
    vi.stubEnv('ABC_PROVIDER_TOKEN', 'invalid-token');
